...
public class AwakingManager
{
	...
	// ClassId => AwakingId
	private final TreeMap<Integer, Integer> _CA = new TreeMap<>();
	// l2jtw add start
	...
	public int[] autoRemoveSkills_Knight =
	{
		1,
		2,
		3,
	...
	public int[] autoRemoveSkills_Warrior =
	{
		2,
		3,
		4,
	...
	public int[] autoRemoveSkills_Rogue =
	{
		1,
		3,
		5,
	...
	public int[] autoRemoveSkills_Archer =
	{
		1,
		3,
		4,
	...
	public int[] autoRemoveSkills_Wizard =
	{
		1,
		2,
		3,
	...
	public int[] autoRemoveSkills_Enchanter =
	{
		1,
		3,
		4,
	...
	public int[] autoRemoveSkills_Summoner =
	{
		1,
		2,
		3,
	...
	public int[] RemoveSkills_Summoner =
	{
		1111,
		1128,
		1225,
	...
	public int[] RemoveSkills_Healer =
	{
		1425
	};
	public int[] RemoveSkills_Dwarf =
	{
		150,
		1321
	};
	public int[] RemoveSkills_Kamael =
	{
		1473
	};
	...
	{
		/*
		 * 603 need add new removeSkills int _classId = player.getClassId().getId(); if (_classId == 139) RemoveSkills = autoRemoveSkills_Knight; else if (_classId == 140) RemoveSkills = autoRemoveSkills_Warrior; else if (_classId == 141) RemoveSkills = autoRemoveSkills_Rogue; else if (_classId ==
		 * 142) RemoveSkills = autoRemoveSkills_Archer; else if (_classId == 143) RemoveSkills = autoRemoveSkills_Wizard; else if (_classId == 144) RemoveSkills = autoRemoveSkills_Enchanter; else if (_classId == 145) RemoveSkills = autoRemoveSkills_Summoner; else if (_classId == 146) RemoveSkills =
		 * autoRemoveSkills_Healer; else RemoveSkills = autoRemoveSkills; for (int i : RemoveSkills) { int level = player.getSkillLevel(i); if (level > 0) { Skill skill = SkillData.getInstance().getSkill(i, level); // _log.info(getClass().getSimpleName() + ":" + player.getName() + ":remove skill:" +
		 * skill.getName() + " " + skill.getId()); player.removeSkill(skill); } } if (_classId >= 139) { if (_classId != 145) { for (int i : RemoveSkills_Summoner) { int level = player.getSkillLevel(i); if (level > 0) { Skill skill = SkillData.getInstance().getSkill(i, level);
		 * player.removeSkill(skill); } } } if (_classId != 146) { for (int i : RemoveSkills_Healer) { int level = player.getSkillLevel(i); if (level > 0) { Skill skill = SkillData.getInstance().getSkill(i, level); player.removeSkill(skill); } } } int _race = player.getRace().ordinal(); if (_race !=
		 * 4) { for (int i : RemoveSkills_Dwarf) { int level = player.getSkillLevel(i); if (level > 0) { Skill skill = SkillData.getInstance().getSkill(i, level); player.removeSkill(skill); } } } if (_race != 5) { for (int i : RemoveSkills_Kamael) { int level = player.getSkillLevel(i); if (level >
		 * 0) { Skill skill = SkillData.getInstance().getSkill(i, level); player.removeSkill(skill); } } } } // player.sendSkillList();
		 */
	}
	...
	public void ClassChange(L2PcInstance player, int paramOne)
	{
		...
		{
			player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.SUBCLASS_TRANSFER_COMPLETED).addSystemString(ClassListData.getInstance().getClass(oldClassId).getClassClientId()).addSystemString(ClassListData.getInstance().getClass(newClassId).getClassClientId())); // Transfer completed.
