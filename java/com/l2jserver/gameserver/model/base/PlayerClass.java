...
public enum PlayerClass
{
	...
	// Awakening
	sigelKnight(Race.HUMAN, Fighter, Awaken),
	tyrrWarrior(Race.HUMAN, Fighter, Awaken),
	othellRogue(Race.HUMAN, Fighter, Awaken),
	yulArcher(Race.HUMAN, Fighter, Awaken),
	feohWizard(Race.HUMAN, Mystic, Awaken),
	issEnchanter(Race.KAMAEL, Fighter, Awaken),
	wynnSummoner(Race.HUMAN, Mystic, Awaken),
	aeoreHealer(Race.HUMAN, Priest, Awaken),
	
	dummyEntry37(null, null, null),
	
	SigelPhoenixKnight(Race.HUMAN, Fighter, Awaken),
	SigelHellKnight(Race.HUMAN, Fighter, Awaken),
	SigelEvaTemplar(Race.ELF, Fighter, Awaken),
	SigelShillienTemplar(Race.DARK_ELF, Fighter, Awaken),
	TyrrDuelist(Race.HUMAN, Fighter, Awaken),
	TyrrDreadnought(Race.HUMAN, Fighter, Awaken),
	TyrrTitan(Race.ORC, Fighter, Awaken),
	TyrrGrandKhavatari(Race.ORC, Fighter, Awaken),
	TyrrMaestro(Race.DWARF, Fighter, Awaken),
	TyrrDoombringer(Race.KAMAEL, Fighter, Awaken),
	OthellAdventurer(Race.HUMAN, Fighter, Awaken),
	OthellWindRider(Race.ELF, Fighter, Awaken),
	OthellGhostHunter(Race.DARK_ELF, Fighter, Awaken),
	OthellFortuneSeeker(Race.DWARF, Fighter, Awaken),
	YulSagittarius(Race.HUMAN, Fighter, Awaken),
	YulMoonlightSentinel(Race.ELF, Fighter, Awaken),
	YulGhostSentinel(Race.DARK_ELF, Fighter, Awaken),
	YulTrickster(Race.KAMAEL, Fighter, Awaken),
	FeohArchmage(Race.HUMAN, Mystic, Awaken),
	FeohSoultaker(Race.HUMAN, Mystic, Awaken),
	FeohMysticMuse(Race.ELF, Mystic, Awaken),
	FeohStormScreamer(Race.DARK_ELF, Mystic, Awaken),
	FeohSoulhound(Race.KAMAEL, Mystic, Awaken),
	IssHierophant(Race.HUMAN, Fighter, Awaken),
	IssSwordMuse(Race.ELF, Fighter, Awaken),
	IssSpectralDancer(Race.DARK_ELF, Fighter, Awaken),
	IssDominator(Race.ORC, Fighter, Awaken),
	IssDoomcryer(Race.ORC, Fighter, Awaken),
	KamaelIssHierophant(Race.KAMAEL, Fighter, Awaken),
	WynnArcanaLord(Race.HUMAN, Mystic, Awaken),
	WynnElementalMaster(Race.ELF, Mystic, Awaken),
	WynnSpectralMaster(Race.DARK_ELF, Mystic, Awaken),
	AeoreCardinal(Race.HUMAN, Priest, Awaken),
	AeoreEvaSaint(Race.ELF, Priest, Awaken),
	AeoreShillienSaint(Race.DARK_ELF, Priest, Awaken);
