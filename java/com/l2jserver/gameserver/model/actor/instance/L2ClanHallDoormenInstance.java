...
public class L2ClanHallDoormenInstance extends L2DoormenInstance
{
	...
	private final String CLANHALL_HTML_PREFIX = "data/html/clanHallDoormen/";
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		if (_hasEvolve && command.startsWith("evolve"))
		{
			if (isOwnerClan(player))
			{
				...
				if (ok)
				{
					html.setFile(player.getHtmlPrefix(), CLANHALL_HTML_PREFIX + "/evolve-ok.htm");
				}
				else
				{
					html.setFile(player.getHtmlPrefix(), CLANHALL_HTML_PREFIX + "/evolve-no.htm");
				}
