...
public class EtcStatusUpdate extends L2GameServerPacket
{
	...
	protected void writeImpl()
	{
		...
		//603 writeD(_activeChar.isAffected(EffectFlag.CHARM_OF_COURAGE) ? 1 : 0); // 1 = charm of courage (allows resurrection on the same spot upon death on the siege battlefield)
		...
		(_activeChar.isAffected(EffectFlag.CHARM_OF_COURAGE) ? 4 : 0)); // 603
	}
}
